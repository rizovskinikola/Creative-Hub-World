export function initMiniDigitalMarketingForm() {
    ...
    (function () {
        ...
        var form_submit = function (e) {
            ...
            if (validate_form()) {
                ...
                window.location.href="/thank-you-mini-digital-marketing-academy";
            }
            return false;
        };
...
export function initMiniDigitalMarketingFooterForm() {
    window.cfields = [];
    window._show_thank_you = function (id, message, trackcmp_url, email) {
        var form = document.getElementById('_form_' + id + '_'), thank_you = form.querySelector('._form-thank-you');
        form.querySelector('._form-content').style.display = 'none';
    ...
    (function () {
        ...
        var form_submit = function (e) {
            ...
            if (validate_form()) {
                ...
                err ? err.parentNode.removeChild(err) : false;
                _load_script('https://akoskarova.activehosted.com/proc.php?' + serialized + '&jsonp=true');
                window.location.href="/thank-you-mini-digital-marketing-information";
            }
            return false;
        };
        addEvent(form_to_submit, 'submit', form_submit);
