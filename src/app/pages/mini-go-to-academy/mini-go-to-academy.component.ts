...
import { initMiniGoToAcademyForm } from './mini-go-to-academy';
import { initMiniGoToAcademyFooterForm } from './mini-go-to-academy';
@Component({
  selector: 'app-mini-go-to-academy',
  templateUrl: './mini-go-to-academy.component.html',
  styleUrls: ['./mini-go-to-academy.component.scss']
})
export class MiniGoToAcademyComponent implements OnInit {
  blueListInfo: string = "Поучени од тоа дека на луѓето им се потребни брзи вештини денес и сега, ја креиравме програмата на првата Мини Go-to-Market. Целосно практична преку реална и применлива работа каде ти самиот ќе работиш дирекно во сите алатки."
  array_of_blue_list: Array<string> =
    [
      ...
      'Оваа Мини Go-to-market Академија е целосно базирана на реални случаи и практики, а во секое од предавањата ќе треба да се вклучите и Вие со Ваше активно учество.'
    ]
  ...
  ngAfterViewInit() {
    initMiniGoToAcademyForm();
    initMiniGoToAcademyFooterForm();
  }
